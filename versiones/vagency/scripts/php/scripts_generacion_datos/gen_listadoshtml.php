...
$listadoshtml.="</ul>";
print($listadoshtml);
//$file = fopen("../../../includes/listados_defecto/enseñanzas.html","w");
//fwrite($file,$listadoshtml);
//fclose($file);
...
function show_cabecera($ent,$nivel="nonivel")
{
	...
	foreach($keys as $key)
	{
		if($key!='ce.codcentro' and $key!='filtros' and $key!='children1' and $key!='children2' and $key!='children3')
		{
			$cabecera.="<div class='col-md-2 tcabecera'>  <b>".$ent[$key]."</b> </div> ";
		}
		if($key=='filtros')
		{
			$cabecera.="<div class='col-md-2 tcabecera' hidden><b>".$ent[$key]."</b> </div> ";
			$afiltros=explode(";",$ent[$key]);
			if($afiltros[0]==1)
				$cabecera.="<div class='col-md-2 tcabecera'><b><i class='fa fa-utensils' aria-hidden='true'></i></b> </div> ";
			else
				$cabecera.="<div class='col-md-2 tcabecera'><b><i class='fa fa-minus-square' aria-hidden='true'></i></b> </div> ";
			if($afiltros[1]==1)
				$cabecera.="<div class='col-md-2 tcabecera'><b><i class='fa fa-bus' aria-hidden='true'></i></b> </div> ";
			else
				$cabecera.="<div class='col-md-2 tcabecera'><b><i class='fa fa-minus-square' aria-hidden='true'></i></b> </div> ";
			if($afiltros[2]==1)
				$cabecera.="<div class='col-md-2 tcabecera'><b><i class='fa fa-calendar-check' aria-hidden='true'></i></b> </div> ";
			else
				$cabecera.="<div class='col-md-2 tcabecera'><b><i class='fa fa-minus-square' aria-hidden='true'></i></b> </div> ";
		}
