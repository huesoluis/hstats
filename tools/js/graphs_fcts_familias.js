            function get_files(){
		var gfiles='php/get_files_fcts_familias.php';
		var csvdir='csvs_fcts_familias/';
		var csvdircompleto='csvs_fcts_familias_dcompletos/';
	   ...
	   function cf(event)
		{	
           ...
           function show_graph(data,csvdir,csvdirc)
			...
			linkgr=gr+"<br><a href='"+dowficheroc+"'><div style='font-size: small;fill: #ba1818;'>Descargar datos completos</div>";
        	        if(i!=0){
